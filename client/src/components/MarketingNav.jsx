  ...
  return (
    <header className="mkt-navwrap">
      ...
      <nav className="mkt-nav">
        <Link to="/" aria-label="ThinkVest home"><Logo size={22} /></Link>
...
const NAV_CSS = `
  ...
  .mkt-btn { display: inline-flex; align-items: center; justify-content: center; font-weight: 600; font-size: 14px; border-radius: ${radius.pill}; padding: 10px 20px; background: ${gradients.brand}; color: #fff; box-shadow: 0 4px 18px rgba(16,185,129,0.3), inset 0 1px 0 rgba(255,255,255,0.22); transition: all .15s ease; }
  .mkt-btn:hover { transform: translateY(-1px); box-shadow: 0 10px 32px rgba(16,185,129,0.45), inset 0 1px 0 rgba(255,255,255,0.22); filter: brightness(1.08); }
